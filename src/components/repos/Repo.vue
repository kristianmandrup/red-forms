  ...
  <md-card md-primary md-with-hover>
    ...
    <md-card-content>
      ...
      <md-input-container>
        ...
        <md-input id="location" v-model="location"></md-input>
      </md-input-container>

      <div class="input-container">
        <label for="branches" class="inputs">Branches</label>
        <div id="environments" v-for="branch in form.branches">
          <md-checkbox :id="branch.id" :value="branch.value" v-model="branch.checked">{{ branch.label }}</md-checkbox>
        </div>
      </div>
      ...
      <md-input-container>
        ...
        <md-button @click.native="addBranch()" class="md-icon-button md-raised">
