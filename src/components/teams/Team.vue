  ...
  <md-card md-primary md-with-hover>
    ...
    <md-card-content>
      ...
      <div class="input-container">
        <label for="projects" class="inputs">Projects</label>
        <div id="projects" v-for="proj in form.projects">
          <md-checkbox :id="proj.id" :value="proj.value" v-model="proj.checked">{{ proj.label }}</md-checkbox>
        </div>
      </div>
