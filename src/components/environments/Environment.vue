    ...
    <md-card-content>
      ...
      <md-input-container>
        ...
        <md-select id="type" v-model="type">
          ...
          <md-option v-for="typ in types" :key="typ.id" :value="typ.value">{{ typ.label }}</md-option>
        </md-select>
      </md-input-container>

      <md-input-container>
        <label for="branch">Branch</label>
        <md-select id="branch" v-model="branch">

          <md-option v-for="branch in branches" :key="branch.id" :value="branch.value">{{ branch.label }}</md-option>
        </md-select>
      </md-input-container>
